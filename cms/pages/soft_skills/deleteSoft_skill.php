...
<head>
    ...
    <title>Eliminar Soft Skill</title>
    
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-1BmE4kWBq78iYhFldvKuhfTAU6auU8tT94WrHftjDbrCEXSU1oBoqyl2QvZ6jIW3" crossorigin="anonymous">
    <link rel="stylesheet" href="deleteSoft_skill.css">
</head>
<body>
    <div>
        <button onclick="window.location.href='./soft_skills.php'" class="voltarBT topleft fa fa-arrow-left "></button>
    </div>
<div class="container text-center">
    <div class="row mt-5">
        <div class="col-12 display-5 text-info">
        Pretende eliminar esta Soft Skill?
        </div>
    </div>
<div class="row my-5">
    <div class="col-12">
...
<input type="hidden" class="form-control" id="id" name="id" value="<?php echo $id?>"> 
    <div class="padding">
        <label id="nome" name="nome"><h4 id="labelFrase">Soft Skill</h4> <div class="quadrado"><?php echo $dados['nome']?></div></label>
    </div>
