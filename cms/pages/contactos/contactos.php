      ...
      <div class="col-12">
        <div class="list-group">
          <a class="list-group-item list-group-item-action active">
            Contactos
            <span class="float-end fw-bold"> <?php echo $stmt->rowCount();?> Contactos</span>
          </a>
            <table>
            ...
            <?php while($row = $stmt->fetch()): ?>
                ...
                <tr>
                    ...
                    <td> 
                        <button onclick="window.location.href='editContacto.php?id=<?php echo $row['id']; ?>'">Editar</button>
                        <button onclick="window.location.href='deleteContacto.php?id=<?php echo $row['id']; ?>'">Apagar</button>
            ...
            <div>
            <a class="btn btn-primary float-end mt-5" href="./criarContacto.php" role="button">Inserir Contacto</a>
            </div>
