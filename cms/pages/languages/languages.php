  ...
  <div class="col-12">
    <div class="list-group">
      <a class="list-group-item list-group-item-action active">
        ...
        <?php while($row = $stmt->fetch()): ?>
            <tr>
                ...
                <td> 
                    ...
                    <button onclick="window.location.href='deleteLanguage.php?id=<?php echo $row['id']; ?>'">Apagar</button>
        ...
        <div>
        <a class="btn btn-primary float-end mt-5" href="./criarLanguage.php" role="button">Inserir Lingua</a>
        </div>
