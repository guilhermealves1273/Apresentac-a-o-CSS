...
<body>
  ...
  $stmt = $pdo->prepare('SELECT frase,id from about_me');
      ...
      <div class="col-12">
        <div class="list-group">
          <a class="list-group-item list-group-item-action active">
            Frases
            <span class="float-end fw-bold"> <?php echo $stmt->rowCount();?> Frases</span>
          </a>
            <table>
            ...
            <?php while($row = $stmt->fetch()): ?>
                ...
                <tr>
                    ...
                    <td> 
                        <button onclick="window.location.href='editFrase.php?id=<?php echo $row['id']; ?>'">Editar</button>
                        <button onclick="window.location.href='deleteFrase.php?id=<?php echo $row['id']; ?>'">Apagar</button>
            ...
            <div>
            <a class="btn btn-primary float-end mt-5" href="./criarFrase.php" role="button">Inserir Frase</a>
            </div>
