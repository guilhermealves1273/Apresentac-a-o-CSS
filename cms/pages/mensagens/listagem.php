      ...
      <div class="col-12">
        <div class="list-group">
          <a class="list-group-item list-group-item-action active">
           Mensagens
            <span class="float-end fw-bold"> <?php echo $stmt->rowCount();?> Mensagens</span>
          </a>
            <table>
            ...
            <?php while($row = $stmt->fetch()): ?>
                ...
                <tr>
                    ...
                    $stmt1=$pdo1->prepare('Select username from user where id=:idUser');
                    $stmt1->bindParam(":idUser", $row['idUser'], PDO::PARAM_INT);
                    $stmt1->execute();
                    # definir o fetch mode
                    ...
                    <td> 
                        <button onclick="window.location.href='visualizar.php?id=<?php echo $row['id']; ?>'">Visualizar </button>
