  ...
  <div class="col-12">
    <div class="list-group">
      <a class="list-group-item list-group-item-action active">
        ...
        <span class="float-end fw-bold"> <?php echo $stmt->rowCount();?> Frameworks</span>
      </a>
        <table>
        <tr>
                <th>Nome</th>
        ...
        <?php while($row = $stmt->fetch()): ?>
            <tr>
                ...
                <td> 
                    ...
                    <button onclick="window.location.href='deleteFramework.php?id=<?php echo $row['id']; ?>'">Apagar</button>
        ...
        <div>
        <a class="btn btn-primary float-end mt-5" href="./criarFramework.php" role="button">Inserir Framework</a>
        </div>
