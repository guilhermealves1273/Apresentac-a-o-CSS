  ...
  <div class="container">
    ...
    <div class="row mt-5">
      <div class="col-12 display-4 text-info">
       Eliminar Utilizador
        <a href="index.php" type="button" class="btn btn-outline-info float-end">
    ...
    <div class="row mt-5">
      <div class="col-12">
          <div class="display-4">Eliminar utilizador</div>
      </div>
    </div>
      ...
      <div class="col-12">
        ...
        ?>
          <div class="alert alert-success" role="alert">
            <strong>Utilizador eliminado com sucesso.</strong>
          </div>
          <a class="btn btn-primary float-end mt-5" href="../../pages/users/users.php" role="button">Eliminar outro utilizador</a>
        <?php
        } else {
        ?>
          ...
          <a class="btn btn-primary float-end mt-5" href="../../pages/users/users.php" role="button">Eliminar Utilizador</a>
        <?php
        }
        ?>
      </div>
