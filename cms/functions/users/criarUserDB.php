      ...
      <div class="col-12">
        ...
        ?>
          <div class="alert alert-success" role="alert">
            <strong>User registado com sucesso.</strong>
          </div>
          <a class="btn btn-primary float-end mt-5" href="../../pages/users/criarUser.php" role="button">Inserir outro User</a>
        <?php
        } else {
        ?>
          ...
          <a class="btn btn-primary float-end mt-5" href="../../pages/users/criarUser.php" role="button">Inserir User</a>
        <?php
        }
        ?>
      </div>
