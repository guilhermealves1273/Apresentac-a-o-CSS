...
<body>
  ...
  if (isset($_POST) && !empty($_POST)) {
    ...
    //  - idlivro
    // Preparação de um array com os dados do livro a eliminar
    $dados = array($id);


    # preparar a query
    $stmt = $pdo->prepare('DELETE FROM ling_Prog WHERE id = ?');
    # executar instrução 
    $stmt->execute($dados);
  } 
  ...
  <div class="container">
    ...
    <div class="row mt-5">
      <div class="col-12 display-4 text-info">
       Eliminar Linguagem de Programação
        <a href="../../pages/lingProg/listagem.php" type="button" class="btn btn-outline-info float-end">
      ...
      <div class="col-12">
        ...
        ?>
          <div class="alert alert-success" role="alert">
            <strong>Linguagem eliminada com sucesso.</strong>
          </div>
          <a class="btn btn-primary float-end mt-5" href="../../pages/lingProg/listagem.php" role="button">Eliminar outra Linguagem</a>
        <?php
        } else {
        ?>
          ...
          <a class="btn btn-primary float-end mt-5" href="../../pages/lingProg/listagem.php" role="button">Eliminar Linguagem</a>
        <?php
        }
        ?>
      </div>
