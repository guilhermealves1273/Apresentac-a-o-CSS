...
<body>
  ...
  if (isset($_POST) && !empty($_POST)) {
    ...
    if(strlen($dados[0])<=200 and strlen($dados[0])>0){
        # preparar a query
    $stmt= $pdo->prepare('Insert into about_me(frase) values(?)');
  ...
  <div class="container">
    ...
    <div class="row mt-5">
     ...
     Criar Frase
        ...
        <a href="../../pages/about_me/about_me.php" type="button" class="btn btn-outline-info float-end">
      ...
      <div class="col-12">
        ...
        ?>
          <div class="alert alert-success" role="alert">
            <strong>Frase criada com sucesso.</strong>
          </div>
          <a class="btn btn-primary float-end mt-5" href="../../pages/about_me/criarFrase.php" role="button">Inserir outra Frase</a>
        <?php
        } else {
        ...
        ?>
          ...
          <a class="btn btn-primary float-end mt-5" href="../../pages/about_me/criarFrase.php" role="button">Inserir Frase</a>
        <?php
        } else {  
        ?>
        <div class="alert alert-danger" role="alert">
