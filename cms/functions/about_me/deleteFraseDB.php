...
<body>
  ...
  if (isset($_POST) && !empty($_POST)) {
    ...
    # preparar a query
    $stmt = $pdo->prepare('DELETE FROM about_me WHERE id = ?');
    # executar instrução 
    $stmt->execute($dados);
  } 
      ...
      <div class="col-12">
        ...
        ?>
          <div class="alert alert-success" role="alert">
            <strong>Frase eliminada com sucesso.</strong>
          </div>
          <a class="btn btn-primary float-end mt-5" href="../../pages/about_me/about_me.php" role="button">Eliminar outra Frase</a>
        <?php
        } else {
        ?>
