...
<body>
  ...
  if (isset($_POST) && !empty($_POST)) {
    ...
    # preparar a query
    $stmt = $pdo->prepare('DELETE FROM educacao WHERE id = ?');
    # executar instrução 
    $stmt->execute($dados);
  } 
      ...
      <div class="col-12">
        ...
        ?>
          <div class="alert alert-success" role="alert">
            <strong>Escola eliminada com sucesso.</strong>
          </div>
          <a class="btn btn-primary float-end mt-5" href="../../pages/education/education.php" role="button">Eliminar outra escola</a>
        <?php
        } else {
        ?>
          ...
          <a class="btn btn-primary float-end mt-5" href="../../pages/education/education.php" role="button">Eliminar Escola</a>
        <?php
        }
        ?>
      </div>
