...
<body>
  ...
  if (isset($_POST) && !empty($_POST)) {
    ...
    $dados=array($nome);
    # preparar a query
    $stmt= $pdo->prepare('Insert into frameworks(nome) values(?)');
      ...
      <div class="col-12">
        ...
        ?>
          <div class="alert alert-success" role="alert">
            <strong>Framework criada com sucesso.</strong>
          </div>
          <a class="btn btn-primary float-end mt-5" href="../../pages/frameworks/criarFramework.php" role="button">Inserir outra Framework</a>
        <?php
        } else {
        ?>
          ...
          <a class="btn btn-primary float-end mt-5" href="../../pages/frameworks/criarFramework.php" role="button">Inserir Framework</a>
        <?php
        }
        ?>
      </div>
