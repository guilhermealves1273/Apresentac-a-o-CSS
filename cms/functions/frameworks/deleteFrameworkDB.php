...
<body>
  ...
  if (isset($_POST) && !empty($_POST)) {
    ...
    # preparar a query
    $stmt = $pdo->prepare('DELETE FROM frameworks WHERE id = ?');
    # executar instrução 
    $stmt->execute($dados);
  } 
  ...
  <div class="container">
    ...
    <div class="row mt-5">
      <div class="col-12 display-4 text-info">
       Eliminar Framework
        <a href="../../pages/frameworks/frameworks.php" type="button" class="btn btn-outline-info float-end">
      ...
      <div class="col-12">
        ...
        ?>
          <div class="alert alert-success" role="alert">
            <strong>Framework eliminado com sucesso.</strong>
          </div>
          <a class="btn btn-primary float-end mt-5" href="../../pages/frameworks/frameworks.php" role="button">Eliminar outra Framework</a>
        <?php
        } else {
        ?>
          ...
          <a class="btn btn-primary float-end mt-5" href="../../pages/frameworks/frameworks.php" role="button">Eliminar framework</a>
        <?php
        }
        ?>
      </div>
