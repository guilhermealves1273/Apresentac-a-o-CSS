...
<body>
  ...
  if (isset($_POST) && !empty($_POST)) {
    ...
    # preparar a query
    $stmt = $pdo->prepare('DELETE FROM soft_skills WHERE id = ?');
    # executar instrução 
    $stmt->execute($dados);
  } 
      ...
      <div class="col-12">
        ...
        ?>
          <div class="alert alert-success" role="alert">
            <strong>Soft Skill eliminado com sucesso.</strong>
          </div>
          <a class="btn btn-primary float-end mt-5" href="../../pages/soft_skills/soft_skills.php" role="button">Eliminar outra Soft Skill</a>
        <?php
        } else {
        ?>
          ...
          <a class="btn btn-primary float-end mt-5" href="../../pages/soft_skills/soft_skills.php" role="button">Eliminar Soft Skill</a>
        <?php
        }
        ?>
      </div>
