...
<body>
  ...
  if (isset($_POST) && !empty($_POST)) {
    ...
    $dados=array($nome,$descricao,$link,$id);
    print_r($dados);

    if(strlen($dados[0])<=100 and strlen($dados[0])>0 and strlen($dados[1]>0 and strlen($dados[1])<=200)){
        # preparar a query
    $stmt= $pdo->prepare('update contactos set nome=?, descricao=?, link=? where id=? ');
  ...
  <div class="container">
    ...
    <div class="row mt-5">
     ...
     Atualizar Contacto
        ...
        <a href="../../pages/contactos/contactos.php" type="button" class="btn btn-outline-info float-end">
      ...
      <div class="col-12">
        ...
        ?>
          <div class="alert alert-success" role="alert">
            <strong>Contacto atualizado com sucesso.</strong>
         
          </div>
          <a class="btn btn-primary float-end mt-5" href="../../pages/contactos/contactos.php" role="button">Atualizar outro contacto</a>
        <?php
        } else {
        ...
        <div class="alert alert-danger" role="alert">
          ...
          <a class="btn btn-primary float-end mt-5" href="../../pages/contactos/contactos.php" role="button">Atualizar Contacto</a>
