      ...
      <div class="col-12">
        ...
        ?>
          <div class="alert alert-success" role="alert">
            <strong>Contacto eliminado com sucesso.</strong>
          </div>
          <a class="btn btn-primary float-end mt-5" href="../../pages/contactos/contactos.php" role="button">Eliminar outro contacto</a>
        <?php
        } else {
        ?>
          ...
          <a class="btn btn-primary float-end mt-5" href="../../pages/contactos/contactos.php" role="button">Eliminar Contacto</a>
        <?php
        }
        ?>
      </div>
