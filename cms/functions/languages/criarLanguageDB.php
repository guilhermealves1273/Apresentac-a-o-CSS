...
<body>
  ...
  if (isset($_POST) && !empty($_POST)) {
    ...
    if(strlen($dados[0])>0 and strlen($dados[0])<=50){
    # preparar a query
    $stmt= $pdo->prepare('Insert into language(nome) values(?)');
  ...
  <div class="container">
    ...
    <div class="row mt-5">
     ...
     Languages
        <a href="../../pages/languages/languages.php" type="button" class="btn btn-outline-info float-end">
    ...
    <div class="row mt-5">
      <div class="col-12">
          <div class="display-4">Criar Language</div>
      </div>
    </div>
      ...
      <div class="col-12">
        ...
        ?>
          <div class="alert alert-success" role="alert">
            <strong>Lingua criada com sucesso.</strong>
          </div>
          <a class="btn btn-primary float-end mt-5" href="../../pages/languages/criarLanguage.php" role="button">Inserir outra Lingua</a>
        <?php
        } else {
            if($tamanhoCorreto==False){
              ...
              <a class="btn btn-primary float-end mt-5" href="../../pages/languages/criarLanguage.php" role="button">Inserir Lingua</a>
