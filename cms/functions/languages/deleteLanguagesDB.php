...
<body>
  ...
  if (isset($_POST) && !empty($_POST)) {
    ...
    # preparar a query
    $stmt = $pdo->prepare('DELETE FROM language WHERE id = ?');
    # executar instrução 
    $stmt->execute($dados);
  } 
      ...
      <div class="col-12">
        ...
        ?>
          <div class="alert alert-success" role="alert">
            <strong>Lingua eliminada com sucesso.</strong>
          </div>
          <a class="btn btn-primary float-end mt-5" href="../../pages/languages/languages.php" role="button">Eliminar outra Lingua</a>
        <?php
        } else {
        ?>
          ...
          <a class="btn btn-primary float-end mt-5" href="../../pages/languages/languages.php" role="button">Eliminar Lingua</a>
        <?php
        }
        ?>
      </div>
